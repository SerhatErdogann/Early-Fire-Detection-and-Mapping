...
Eğitilmiş checkpoint için **tek protokol**: giriş tensörüne **Gaussian blur severity=1** (yalnızca bu eval forward’unda). Çoklu bozunma grid’i veya clean satırı yoktur.
